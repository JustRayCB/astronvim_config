...
return {
...

  {
    ...
    opts = function(_, opts)
      ...
      local root_markers = { ".git", "mvnw", "gradlew", "pom.xml", "build.gradle", ".project", "notes.txt" }
    ...
    config = function(_, opts)
      ...
      vim.api.nvim_create_autocmd("Filetype", {
        ...
        callback = function()
          local root_markers = { ".git", "mvnw", "gradlew", "pom.xml", "build.gradle", ".project", "notes.txt" }
          local root_dir = require("jdtls.setup").find_root(root_markers)
          if root_dir and root_dir ~= nil then
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(args)
          ...
          if client.name == "jdtls" and root_dir ~= nil then require("jdtls.dap").setup_dap_main_class_configs() end
        end,
      })
    end,
  },
